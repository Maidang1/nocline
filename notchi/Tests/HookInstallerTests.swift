...
final class HookInstallerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempDirectoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("notchi-hook-installer-\(UUID().uuidString)", isDirectory: true)
    ...
    func testCodexInstallReportsFeatureEnableFailure() throws {
        ...
        let scriptURL = tempDirectoryURL.appendingPathComponent("notchi-codex-hook.sh")
